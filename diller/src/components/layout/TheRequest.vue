<template>
  <base-card v-if="show" class="request">
    <svg
      v-if="valid"
      width="70px"
      height="70px"
...
.invalid__btn:hover {
  background-color: rgba(194, 24, 7, 0.5) !important;
  border-color: rgba(194, 24, 7, 0.5) !important;
}
