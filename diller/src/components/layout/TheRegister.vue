    ...
    <section>
      <form @submit.prevent="submitForm">
        ...
        <div class="form-control" :class="{ invalid: !fullName.isValid }">
          <p v-if="!fullName.isValid">* {{ $t("register.user-error") }}</p>
          <div class="form__div">
            <svg
              width="29"
              height="28"
        ...
        <div class="form-control" :class="{ invalid: !email.isValid }">
          <p v-if="!email.isValid">* {{ $t("register.email-error") }}</p>
        ...
        <div
          class="form-control"
          :class="{ invalid: !password.isValid || !password.byte }"
        >
          <p v-if="!password.isValid">* {{ $t("register.pass-error") }}</p>
          <p v-else-if="!password.byte">* {{ $t("register.pass-byte") }}</p>
          <div class="form__div">
            <svg
              width="28"
              height="28"
            ...
            >
              <path
                ...
                fill="#8F92A1"
                :class="{ fill: !password.isValid || !password.byte }"
              />
            </svg>
        ...
        <div class="form-control" :class="{ invalid: !confirm.isValid }">
          <p v-if="!confirm.isValid">* {{ $t("register.conf-error") }}</p>
        ...
        <div class="form-control" :class="{ invalid: !phoneNumber.isValid }">
          <p v-if="!phoneNumber.isValid">* {{ $t("register.phone-error") }}</p>
...
export default {
  ...
  methods: {
    ...
    validateForm() {
      ...
      if (this.phoneNumber.val === "" || this.phoneNumber.val.length < 8) {
