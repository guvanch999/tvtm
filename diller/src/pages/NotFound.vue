  ...
  <div class="not_found">
    ...
    >
      ...
      <path
        ...
        fill="#2f2e41"
      />
      <circle cx="559" cy="744.5" r="43" fill="#3d5cb7" />
      <circle cx="54" cy="729.5" r="43" fill="#3d5cb7" />
      <circle cx="54" cy="672.5" r="31" fill="#3d5cb7" />
      <circle cx="54" cy="624.5" r="22" fill="#3d5cb7" />
    </svg>

    <div class="not_found--info">
      <h1>404</h1>
      <h2>Ups...Sahypa tapylmady...</h2>
      <base-button link to="/">Esasy sahypa dolan</base-button>
    </div>
  </div>
</template>
